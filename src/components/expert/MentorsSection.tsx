  ...
  const mentors = [
    {
      ...
      role: 'AI Systems Architect & Knowledge Engineering Expert',
      company: 'Codingbyts AI-Tech Private Limited',
      bio: 'Mohit blends full-stack development with knowledge engineering to design and scale AI-powered systems. With expertise in Python, React, Node.js, and modern frameworks, he architects intelligent applications and drives innovation in data-driven solutions.',
      expertise: [
...

    {
      ...
      bio: 'Karthikeyan brings deep experience in building enterprise-grade web platforms and API ecosystems. Having led impactful projects at TritonTech, Chordify, and Juice Media, he specializes in designing scalable architectures, seamless integrations, and resilient digital solutions across industries.',
      expertise: [
        'React.js',
        'Angular',
        'Node.js',
...

    {
      ...
      role: 'Systems Design & Cloud Architecture Mentor',
      company: 'Netflix',
      bio: 'Manjit focuses on high-scale system design, database performance, and distributed architectures. As a mentor and thought leader, he guides teams in optimizing infrastructure, strengthening reliability, and implementing cloud-native strategies for long-term growth.',
    ...
    },
    {
      ...
      role: 'Cloud Infrastructure & DevOps Strategist',
      company: 'Amazon Web Services',
      bio: 'Taranjeet is an expert in DevOps and cloud transformation, with strong command over database and automation technologies. He enables organizations to build scalable, secure, and efficient platforms by bridging infrastructure strategy with hands-on execution.',
      expertise: [
        'DevOps',
