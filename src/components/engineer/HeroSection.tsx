  ...
  return (
    <section className="py-6 sm:py-8 md:py-12 lg:py-16 xl:py-20 flex items-center justify-center bg-gradient-to-br from-[#2A6B65] to-[#1F514C] w-full min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh]">
      <div className="w-full container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        {/* Main Headline */}
        <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl flex flex-col text-white font-semibold mb-4 sm:mb-6 md:mb-8 leading-tight sm:leading-tight md:leading-tight lg:leading-tight xl:leading-tight">
          <span className="block">Global Tech Careers,</span>
          <span className="block">Built on Your Skills</span>
        </h1>

        {/* Description Text */}
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-normal text-[#3FAE2A] mb-6 sm:mb-8 md:mb-10 leading-relaxed sm:leading-relaxed md:leading-relaxed">
        ...
        <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl font-normal text-white leading-relaxed sm:leading-relaxed md:leading-relaxed">
